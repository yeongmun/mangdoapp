...
현재 **1단계(PoC)**: DWG 업로드 → APS 변환 → 태블릿 뷰어 → 펜/드래그로 손상 입력 → 도면 좌표 JSON 저장.
...
- 설계: `docs/superpowers/specs/2026-09-10-phase1-poc-design.md`(1단계 PoC), `docs/superpowers/specs/2026-09-12-damage-types-design.md`(손상 유형 체계)
